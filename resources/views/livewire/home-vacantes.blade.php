            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            <a class="text-3xl font-extrabold text-gray-500"
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                                class="bg-indigo-600 block text-center p-3 text-sm uppercase font-bold text-white rounded-lg hover:bg-indigo-900">
                                Ver Vacante
                            </a>
                        </div>
                    </div>
                @empty
                    <p class="text-gray-600 text-sm text-center p-3">No hay vacantes aun</p>
                @endforelse
            </div>
        </div>
